!function(a, b) {
    ...
    function $a(a, b, c) {
        ...
        return Ma.test(f) ? f : (d = g && (o.boxSizingReliable() || f === a.style[b]), f = parseFloat(f) || 0, 
...
var menu = function() {
    ...
    var subbMenu = function() {
        $item.hover(function() {
            $(this).find($subMenu).stop().slideToggle(1e3);
        });
    };
    var plus = function() {
        $plus.on("click", function() {
            $(this).find($level).stop().slideToggle(1e3);
        });
    };
    var subb = function() {
        $sub.hover(function() {
    ...
    var subb2 = function() {
        $sub2.hover(function() {
            $(this).find($level2).stop().slideToggle(1e3);
        });
    };
